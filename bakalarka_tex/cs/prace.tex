...
\def\Podekovani{%
Děkuji svému vedoucímu, který mi pomohl najit zajímavé zaměření mé práce, přístup k otevřeným datům a pomoc při vypracování.
\bigbreak
A také všem přátelům, kteří mi pomohli se stylistikou psaného textu.
}
