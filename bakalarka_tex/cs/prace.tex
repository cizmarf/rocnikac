...
name={GEOJSON},%
description={standardní formát navržený pro reprezentaci jednoduchých prostorových geografických dat}%
}
...
\newglossaryentry{chaps}{%
name={CHAPS},%
description={CHAPS s. r. o.}%
}
...
\def\Podekovani{%
Především děkuji svému vedoucímu, který mi pomohl najit zajímavé zaměření mé práce, přístup k otevřeným datům a pomoc při vypracování.
