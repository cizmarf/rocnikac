...
for e in num:
	...
	ax.scatter(model.norm_data.get_day_times(), model.norm_data.get_shapes(), model.norm_data.get_coor_times())  # known data
	...
	plt.title("From " + e[0].split()[0] + " to " + e[0].split()[1] + ", occurrences " + str(e[1]) + ", name " + model.model.get_name())
	plt.show()
