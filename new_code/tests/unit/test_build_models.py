...
class TestBuil_models(unittest.TestCase):
	def save_specify_model(self, dep = 221406, arr = 223778):
		...
		# self.assertEqual(5649, rows_to_save_bss)
		# self.assertEqual(4222, rows_to_save_hol)
